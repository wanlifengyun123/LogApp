...
public class CitySelectActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.img_back://���ذ�ť����
			finish();
			overridePendingTransition(0, R.anim.slide_out_right);
			break;
		case R.id.btn_submit://ȷ����ť����
		...
		if (ids[0] == v.getId()) {
			...
			if (city.getProvinceCode() == null|| city.getProvinceCode().equals("")) {
				current = 0;
				Toast.makeText(CitySelectActivity.this, "��û��ѡ��ʡ��",
			...
			if (city.getProvinceCode() == null
				...
				Toast.makeText(CitySelectActivity.this, "��û��ѡ�����",
						Toast.LENGTH_SHORT).show();
				current = 1;
